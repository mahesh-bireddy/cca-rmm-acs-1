...
For information on integrating the binaries into the target platform, test suite execution flow, analysing the test results and more, see [Validation Methodology](./docs/Arm%20CCA%20RMM%20Architecture%20Compliance%20Suite%20Validation%20Methodology.pdf) document.
